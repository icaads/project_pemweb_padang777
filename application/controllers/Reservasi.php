...
class Reservasi extends CI_Controller{
	...
	public function false(){
		...
		$data['modal_picture'] = $this->load->view('include/modal_picture.php',NULL,TRUE);
		$data['modalcss'] = $this->load->view('include/modalcss.php',NULL,TRUE);
		$this->load->view('pages/reservationformfalse.php',$data);
	...
	function pesan(){
		...
		$this->form_validation->set_rules('tanggalreservasi','Tanggal Reservasi',$tanggal > date('Y-m-d'));
		...
		if($this->form_validation->run() == FALSE){
			redirect(base_url('reservasi/false'));
		}
		else {
