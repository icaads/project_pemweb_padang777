...
<div class="container">
  <a class="navbar-brand" href="<?php echo base_url('index.php/Admin/admin_website'); ?>"> <img src="<?=base_url();?>/assets/picture/logo.png"><font face="Brush Script MT" size="6pt"> Padang 777 </font></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="<?php echo base_url('Admin/admin_website');?>"> Beranda <span class="sr-only"> current) </span></a>
          </li>
          <li class="nav-item">
